...
import com.zzang.chongdae.domain.model.participant.Participation

fun com.zzang.chongdae.data.remote.dto.response.offering.ParticipationResponse.toDomain() =
    Participation(
