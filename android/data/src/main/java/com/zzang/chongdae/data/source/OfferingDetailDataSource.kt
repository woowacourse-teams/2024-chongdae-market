...
interface OfferingDetailDataSource {
    suspend fun fetchOfferingDetail(offeringId: Long): Result<com.zzang.chongdae.data.remote.dto.response.offering.OfferingDetailResponse, DataError.Network>

    suspend fun saveParticipation(participationRequest: com.zzang.chongdae.data.remote.dto.request.ParticipationRequest): Result<Unit, DataError.Network>
