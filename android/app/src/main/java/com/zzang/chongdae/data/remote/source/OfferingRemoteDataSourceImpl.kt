...
constructor(
    ...
    override suspend fun fetchOfferings(
        ...
        safeApiCall { service.getOfferings(filter, search, lastOfferingId, pageSize) }
    ...
    override suspend fun fetchFilters(): Result<FiltersResponse, DataError.Network> =
        safeApiCall { service.getFilters() }
    ...
    override suspend fun patchOffering(
        ...
        safeApiCall { service.patchOffering(offeringId, offeringModifyRequest) }
