...
class OfferingWriteViewModelTest {
    ...
    fun setUp() {
        ...
        val postOfferingUseCase = PostOfferingUseCase(fakeOfferingRepository)
        val uploadImageFileUseCase = UploadImageFileUseCase(fakeOfferingRepository)
        val postProductImageOgUseCase = PostProductImageOgUseCase(fakeOfferingRepository)
